  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-2">
       ...
       <div className="row mt-5 border-top text-muted" style={{lineHeight:"1.8", fontSize:"1.1em"}}>
        <div className="col-6 p-5">
            <p>We kick-started operations on the 11th of August, 2025 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company GrowTrade, a combination of "Grow" and "Trade", the Sanskrit word for barrier.</p>
